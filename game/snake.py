...
import time
import random
from game.myturtle import create_turtle,set_screen,create_pen
class Snake:
    def __init__(self,title="Snake Game",width=600,height=600,bgcolor="white",boundary_color="black",snake_speed=20,snake_color="white",snake_shape="square",food_color="red",food_shape="circle",difficulty=True,on_gameover=None):
...
if __name__=="__main__":
    snake=Snake(title="Snake Game By Tarun Bisht",bgcolor="black",snake_shape="circle",food_shape="square")
    snake.play_game()
